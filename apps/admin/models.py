...
class Order(models.Model):
    ...
    sale_price = models.PositiveIntegerField(verbose_name='할인가')
    delivery_cost = models.PositiveIntegerField(verbose_name='배송비', default=1200)
    payment_amount = models.PositiveIntegerField(verbose_name='최종결제액')
    coupon = models.ForeignKey(Coupon, on_delete=models.DO_NOTHING, null=True, verbose_name='사용 쿠폰')
