...
class CouponType(models.Model):
    ...
    min_price = models.DecimalField(verbose_name='조건(최소금액)', null=True, max_digits=10, decimal_places=2)
    max_dc_price = models.DecimalField(verbose_name='조건(최대할인금액)', null=True, max_digits=10, decimal_places=2)
    ...
    value = models.DecimalField(verbose_name='값', null=True, max_digits=10, decimal_places=2)
...
class Coupon(models.Model):
    ...
    issue_date = models.DateField(verbose_name='발급 날짜', auto_now_add=True)
    ...
    sale_amount = models.DecimalField(verbose_name='할인금액', max_digits=10, decimal_places=2, null=True)
