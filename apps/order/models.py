...
class Order(models.Model):
    ...
    price = models.DecimalField(verbose_name='정가', max_digits=20, decimal_places=2)
    sale_price = models.DecimalField(verbose_name='할인가', max_digits=20, decimal_places=2, default=0)
    delivery_cost = models.DecimalField(verbose_name='배송비', max_digits=20, decimal_places=2, default=1200)
    payment_amount = models.DecimalField(verbose_name='최종결제액', default=0, max_digits=20, decimal_places=2)
    coupon = models.CharField(null=True, verbose_name='사용 쿠폰', max_length=20)
